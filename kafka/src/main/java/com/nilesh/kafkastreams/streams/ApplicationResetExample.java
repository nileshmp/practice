...
public class ApplicationResetExample {
    public static String inputTopic = "input-topic-1";
    public static String outputTopic = "output-topic-1";
    ...
    public static void main(final String[] args) throws IOException {
        ApplicationResetExample applicationResetExample = new ApplicationResetExample();
        applicationResetExample.startStreams(false);
    }

    public void startStreams(boolean resetState)
    {
        final String bootstrapServers = BOOT_STRAP_SERVERS;
